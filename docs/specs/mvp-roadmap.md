...
**Exit:** coach can get paid and onboard a client without leaving Tend.

## Phase 5 — Billing, metering, launch-ready (week 6–7)
- [ ] Stripe Billing for **Tend's own** subscription (Solo/Pro/Studio) + trial + founder coupon.
