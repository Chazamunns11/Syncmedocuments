# Tend — Pricing Strategy & Research
...
GHL's metered SMS/email is the #1 source of bill-shock complaints. Tend's rule: **bundle generous
...
**Gap Tend fills:** coach-native CRM + booking + payments + contracts **with** a real automation
